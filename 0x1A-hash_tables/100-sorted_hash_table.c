 ...
 * Else - a pointer points to new sorted hash table.
 */
 ...
 * Return: If the key cannot be matched, then - NULL.
 ...
 * @ht: Pointer points to the sorted hash table to print.
 */
 ...
 * @ht: ppoints to sorted hash table.
 */
